...
public class ProvinceController {
    ...
    public ModelAndView save(@ModelAttribute("province")Province province){
        ModelAndView modelAndView = new ModelAndView("/province/create");//redirect:/province
    ...
    public ModelAndView updateProvince(@ModelAttribute("province") Province province){
        iProvinceService.save(province);
        ModelAndView modelAndView = new ModelAndView("/province/edit");//redirect:/province
